...
Margo - персональный AI ассистент для помощи в чтении статей и анализе видео с конференций. Сервис позволяет:
- искать статьи по интересующей тематике в интернете
- давать краткое саммари по найденным статьям
- отвечать на вопросы по конкретной статье
- искать информацию в видео с конференции
- персонализировать цифрового аватара под свои нужды(настраивать внешний вид, стиль речи)

### 1. Цели и предпосылки
#### 1.1. Зачем идем в разработку продукта?

- Бизнес-цель:
  - Создать сервис с интерактивным аватаром, который поможет пользователям искать и читать статьи, искать ключевую информацию из видео и анализировать схемы нейросетевых архитектур.
- Почему станет лучше, чем сейчас, от использования ML
  ...
  - Использование машинного обучения позволит лучше понимать статьи, выделять ключевые моменты из видео в контексте и упрощать сложную информацию.
...
Разрабатать систему, состоящую из 3 компонент:
...
- supervisor для выбора инструментов при ответе на вопрос
- RAG
